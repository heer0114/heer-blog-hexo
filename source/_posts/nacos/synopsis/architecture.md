...
内容摘抄自[Nacos官方文档](https://nacos.io/zh-cn/docs/v2/quickstart/quick-start.html)，可以点击链接移步官方文档

{% endnote %}

## 基本架构及概念

![nacos_arch.jpg](nacos_arch.jpg)
...
![nacos-logic.jpg](nacos-logic.png)
...
![nacos_data_model](nacos_data_model.jpeg)

### 服务领域模型

![nacos_naming_data_model](nacos_naming_data_model.jpeg)

### 配置领域模型

围绕配置，主要有两个关联的实体，一个是配置变更历史，一个是服务标签（用于打标分类，方便索引），由 ID 关联。

![nacos_config_er](nacos_config_er.jpeg)
...
![nacos_sdk_class_relation](nacos_sdk_class_relation.png)
