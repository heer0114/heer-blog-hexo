...
![img](https://pdai.tech/images/arch/arch-x-lb-1.png)
...
![img](https://pdai.tech/images/arch/arch-x-lb-2.png)
...
![img](https://pdai.tech/images/arch/arch-x-lb-3.png)
...
![img](https://pdai.tech/images/arch/arch-x-lb-4.png)
...
![img](https://pdai.tech/images/arch/arch-x-lb-5.png)
...
![img](https://pdai.tech/images/arch/arch-x-lb-6.png)

以上模式适合有动静分离的场景，反向代理服务器（集群）可以起到缓存和动态请求分发的作用，当时静态资源缓存在代理服务器时，则直接返回到浏览器。如果动态页面则请求后面的应用负载均衡（应用集群）。

方式二，如下图：

![img](https://pdai.tech/images/arch/arch-x-lb-7.png)
